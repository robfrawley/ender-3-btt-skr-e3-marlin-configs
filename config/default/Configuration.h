...
#define STRING_CONFIG_H_AUTHOR "(Rob Frawley 2nd, BTT-SKR-Mini-E3-V1.2, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 (BTT-SKR-Mini-E3-V1.2)"
